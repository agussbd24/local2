...
export default function KitchenDashboard() {
  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-white">
      <section className="border-b border-white/[0.06] bg-[radial-gradient(ellipse_at_top_left,rgba(251,191,36,0.12),transparent_40%),#050505]">
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="animate-fade-in-up">
              <div className="flex items-center gap-4">
                ...
                <a
                  href="/stats"
                  className="inline-flex items-center gap-2 rounded-xl glass px-3 py-2 text-sm text-neutral-400 transition-all duration-300 hover:text-violet-300"
                >
                  <BarChart3 size={16} />
                  Estadísticas
                </a>
              ...
              <div className="mt-5 flex items-center gap-4">
                <span className="grid h-14 w-14 place-items-center rounded-2xl bg-gradient-to-br from-amber-400 to-amber-300 text-neutral-950 shadow-glow">
                  <ChefHat size={28} />
                </span>
                <div>
            ...
            <div className="grid grid-cols-4 gap-3 lg:min-w-[700px] animate-fade-in-up stagger-2">
              ...
              <div className="rounded-2xl border border-amber-400/20 bg-amber-500/10 p-5">
                <p className="text-xs font-bold uppercase tracking-wide text-amber-200/70">Preparando</p>
                <p className="mt-2 text-4xl font-bold text-amber-100">{metrics.preparing}</p>
              </div>
              <div className="rounded-2xl border border-emerald-400/20 bg-emerald-500/10 p-5">
                <p className="text-xs font-bold uppercase tracking-wide text-emerald-200/70">Listos</p>
                <p className="mt-2 text-4xl font-bold text-emerald-100">{metrics.ready}</p>
              </div>
            </div>
          </div>
