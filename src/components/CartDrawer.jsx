...
export default function CartDrawer({ open, onClose, onCheckout }) {
  ...
  return (
    ...
    >
      ...
      />
      <aside
        className={`absolute right-0 top-0 flex h-full w-full max-w-md flex-col border-l border-white/[0.06] bg-neutral-950/95 backdrop-blur-2xl shadow-2xl transition-transform duration-500 ease-out ${
      ...
      >
        ...
        <div className="border-t border-white/[0.06] p-6">
          ...
          <button
            ...
            onClick={onCheckout}
            className="h-14 w-full rounded-2xl bg-gradient-to-r from-amber-400 to-amber-300 px-5 py-4 text-base font-bold text-neutral-950 shadow-glow transition-all duration-300 hover:-translate-y-0.5 hover:from-amber-300 hover:to-amber-200 disabled:cursor-not-allowed disabled:from-neutral-700 disabled:to-neutral-700 disabled:text-neutral-400 disabled:shadow-none"
          >
